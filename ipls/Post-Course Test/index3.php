...
var trainer_id = <?php echo $_SESSION['trainer_id']; ?>;
...
<script>
		(function()
		{
			...
			// $('#qqq').change(function(){ alert('oooh!!!!!'); });
		})();
